  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const nextjsLambda = new lambda.Function(this, 'NextJsLambda', {
      ...
      environment: {
        ...
        // Use dynamodb-lite for tag cache (no table needed, no persistence between cold starts)
        // If you use revalidateTag(), change to 'dynamodb' and provision the DynamoDB table
